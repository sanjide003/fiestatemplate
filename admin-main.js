...
const finalEntryExportEvents=(category='')=>finalEntryFilteredEvents({cat:category||finalEntryDownloadValue('final-entry-download-category'),stage:finalEntryDownloadValue('final-entry-download-stage'),gender:finalEntryDownloadValue('final-entry-download-gender'),participation:'all'}).filter(event=>event.cancelled!==true&&registrations.some(reg=>reg.eventId===event.id));
