...
const STUDENT_REPORT_COLUMNS=[['sl','Sl No'],['chestNo','Chest No'],['name','Student Name'],['className','Class'],['category','Category'],['gender','Gender'],['team','Team'],['totalEvents','Total Participated Events'],['publishedResultEvents','Published Result Events'],['totalPoints','Total Points'],['first','First'],['second','Second'],['third','Third']];
